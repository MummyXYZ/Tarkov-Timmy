...
class TK(commands.GroupCog, name = "tk"):
    ...
    @app_commands.choices(category=[Choice(name="Description", value="description"),Choice(name="Video Link", value="video_link")])
    async def edit(self, interaction: discord.Interaction, id: int, category: str, value: str) -> None:
        await interaction.response.defer()
    ...
    async def list(self, interaction: discord.Interaction, killer: discord.Member) -> None:
        await interaction.response.defer()
    ...
    @app_commands.describe(
        target="A User/Role to modify"
    )
    async def perms(self, interaction: discord.Interaction, target: Union[discord.Member, discord.Role] = None) -> None:
        await interaction.response.defer()
